...
export function ToNumber(): PropertyDecorator {
  return Transform(
    (params) => {
      ...
      if (isArray(value)) return (value as string[]).map((v) => Number(v));
...
export function ToInt(): PropertyDecorator {
  return Transform(
    (params) => {
      ...
      if (isArray(value)) return (value as string[]).map((v) => Number.parseInt(v));
...
export function ToTrim(): PropertyDecorator {
  return Transform(
    (params) => {
      ...
      if (isArray(value)) return (value as string[]).map((v) => trim(v));
...
export function ToLowerCase(): PropertyDecorator {
  return Transform(
    (params) => {
      ...
      if (isArray(value)) return (value as string[]).map((v) => v.toLowerCase());
...
export function ToUpperCase(): PropertyDecorator {
  return Transform(
    (params) => {
      ...
      if (isArray(value)) return (value as string[]).map((v) => v.toUpperCase());
